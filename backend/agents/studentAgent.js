...
- Multi-Depth Summarization with HARD MINIMUMS:
    - "short": MINIMUM 200 words. Cover every major topic discussed. A student should be able to read this and understand all the main takeaways of the lecture.
    - "medium": MINIMUM 500 words. Include key definitions, examples mentioned by the lecturer, the logical flow of arguments, and connections between topics.
    - "full": MINIMUM 1000 words. This must be a comprehensive substitute for watching the lecture. Include ALL key concepts, definitions, formulas, examples, analogies used by the lecturer, transitions between topics, and conclusions. Structure with clear paragraphs. A student who reads only this should be able to pass an exam on the material.
...
Return a JSON object with this exact schema:
{
  ...
  "summaries": {
    "short": "string — MINIMUM 200 words covering all major topics",
    "medium": "string — MINIMUM 500 words with definitions, examples, and logical flow",
    "full": "string — MINIMUM 1000 words, comprehensive lecture substitute with all details"
  },
  "flashcards": [
    {
...
4. The "short" summary MUST be at least 200 words. The "medium" MUST be at least 500. The "full" MUST be at least 1000. These are HARD MINIMUMS. Do not go under.
